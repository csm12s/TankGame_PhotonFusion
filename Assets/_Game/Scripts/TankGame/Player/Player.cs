...
namespace PhotonGame.TankGame
{
    ...
    public class Player : NetworkBehaviour, IDamagable
    {
        ...
        [Networked]
        private TickTimer invincibleTimer { get; set; } //invulnerability
        ...
        public bool isActivated
        {
            get
            {
                return gameObject.activeInHierarchy
                    && (state == State.Active || state == State.Spawning);
            }
        }
        ...
        public Quaternion hullRotation => _body.rotation;
        ...
        public void InitNetworkState(int maxLives, int tankNumber)
        {
            state = State.New;
            lives = maxLives;
            life = MAX_HEALTH;
        ...
        public void InitVisual(int matId)
        {
            SetMaterial(matId);
        ...
        private void SetMeshOrientation()
        {
            ...
            if (moveDirection.magnitude > 0.1f)
                _body.forward = Vector3.Lerp(_body.forward, new Vector3(moveDirection.x, 0, moveDirection.y) * multiplier, Time.deltaTime * 10f);
        ...
        public void Move()
        {
            ...
            // todo track sound play when move
            //_audioEmitter.Play();
        }
        ...
        public void TakeDamage(Vector3 impulse, int damage, PlayerRef attacker)
        {
            if (!isActivated || !invincibleTimer.Expired(Runner))
                return;
            ...
            invincibleTimer = TickTimer.CreateFromSeconds(Runner, 0.1f);
        ...
        private void CheckRespawn()
        {
            ...
            SpawnPoint spawnPoint = GetLevelManager().GetPlayerSpawnPoint(playerID);
            if (spawnPoint != null && _respawnInSeconds <= 0)
            {
                ...
                invincibleTimer = TickTimer.CreateFromSeconds(Runner, 1);
