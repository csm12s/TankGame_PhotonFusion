    ...
    public class Bullet : Projectile
    {
        ...
        private void MoveBullet()
        {
            ...
            if (!destroyed)
            {
                ...
                {
                    vel.y += deltaTime * _bulletSettings.gravity;
                    ...
                    if (Runner.LagCompensation.Raycast(pos - 0.5f * dir, dir, Mathf.Max(_bulletSettings.radius, speed * deltaTime), Object.InputAuthority, out var hitinfo, _bulletSettings.hitMask.value, HitOptions.IncludePhysX))
                    {
                ...
                for (int i = 0; i < cnt; i++)
                {
                    ...
                    if (other)
                    {
                        ...
                        if (target != null)
                        {
                            ...
                            target.TakeDamage(impulse, _bulletSettings.areaDamage, Object.InputAuthority);
                        }
                    }
                }
            }
