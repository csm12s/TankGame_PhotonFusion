using Fusion;
using PhotonGame.FusionHelpers;
using PhotonGame.UIHelpers;
using Tanknarok.UI;
using TMPro;
using UnityEngine;
...
namespace PhotonGame.TankGame
{
    ...
    public class GameLauncher : MonoBehaviour
    {
        ...
        [SerializeField] private TMP_InputField _tankNumber;
        ...
        public void OnEnterRoom()
        {
            if (GateUI(_uiRoom))
            {
                ...
                levelManager.selectedLevel = int.Parse(_levelNumber.text.ToString());

                launcher.Launch(_gameMode, 
                    _room.text, 
                    levelManager, 
        ...
        private void OnSpawnPlayer(NetworkRunner runner, PlayerRef playerref)
        {
            ...
            void InitNetworkState(NetworkRunner runner, NetworkObject networkObject)
            {
                ...
                player.InitNetworkState(GameManager.MAX_LIVES, int.Parse(_tankNumber.text.ToString()));
            }
        }
